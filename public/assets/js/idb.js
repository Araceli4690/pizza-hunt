...
let db;
//establish a connection to indexdb databse called  'pizza_hunt' and set it to version 1
//.open method takes in 2 params: the name of db you want to create and the version of the db
